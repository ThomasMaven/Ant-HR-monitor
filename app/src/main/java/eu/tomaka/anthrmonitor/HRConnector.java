...
public class HRConnector
        extends Watcher implements IDeviceStateChangeReceiver, IPluginAccessResultReceiver<AntPlusHeartRatePcc>
{
    ...
    private void subscribeToEvents() {
        hrPcc.subscribeHeartRateDataEvent(new IHeartRateDataReceiver() {
            ...
            public void onNewHeartRateData(final int currentMessageCount, final int computedHeartRate, final long heartBeatCounter) {
                ...
                HRRec hrrec = new HRRec ( currentMessageCount, new Date(), (byte) computedHeartRate, (int) heartBeatCounter );
                newBeat(hrrec);
            }
        });
/*
